# ADR-0010 — Decisões de produto do MVP do porteiro
...
O levantamento do Supervisor Eletrônico (ver [ADR-0009](0009-reducao-escopo-supervisor-eletronico.md))
...
Canal do MVP é **push (Expo)** — WhatsApp/e-mail ficam para a Fase 1.2 (ADR-0009,
...
- **WhatsApp desde o MVP.** Adiada (custo + API oficial), ver ADR-0009.
